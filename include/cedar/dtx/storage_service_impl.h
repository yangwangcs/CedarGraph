...
class MetaServiceNodeClient {
 public:
  ...
  virtual StatusOr<cedar::meta::PartitionAssignment> GetPartitionAssignment(
      PartitionID partition_id);
  ...
  virtual Status UpdatePartitionAssignment(const cedar::meta::PartitionAssignment& assignment);
