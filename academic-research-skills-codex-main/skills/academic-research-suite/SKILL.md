...
description: Use when the user asks for deep research, literature review, academic paper writing, manuscript review, peer review, research-to-paper workflows, experiment planning, or statistical interpretation
metadata:
  version: "0.1.8"
